import type { Service, ServiceKey, ServiceStatus, Shelf } from "../types";

export const services: Service[] = [
  { key: "syncthing", label: "Syncthing", detail: "vault mirror", endpoint: "/health/syncthing" },
  { key: "terminal", label: "Terminal", detail: "vault shell", endpoint: "/health/terminal" },
...
export const shelves: Shelf[] = [
  { name: "Index", detail: "Vishal.ai ideas", count: "01" },
